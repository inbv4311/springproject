...
<div id="footer_wrap">
  <footer id="footer">
    <h2><a href="#" target="_blank" title="새 창 열림"><img src="/img/logo.png" style="width:100px;" alt="FEEF"></a></h2>
    <ul class="foot_menu">
      <li><a href="#">이용약관</a></li>
      <li><a href="#"><strong>개인정보처리방침</strong></a></li>
      <li><a href="#">이메일주소무단수집거부</a></li>
      <li><a href="#">저작권안내</a></li>
      <li><a href="#" class="cscenter">고객센터 <strong>1588-3588</strong></a></li>
    </ul>
    <ul class="sns">
      <li><a href="#" target="_blank" title="새 창 열림"><img src="/img/btn_foot_instagram.png" alt="인스타그램"></a></li>
      <li><a href="#" target="_blank" title="새 창 열림"><img src="/img/btn_foot_youtube.png" alt="유튜브"></a></li>
      <li><a href="#" target="_blank" title="새 창 열림"><img src="/img/btn_foot_kakao.png" alt="카카오"></a></li>
    </ul>
    <p class="company_info"><b>FEEF 만든 김수빈</b> <b>부상궁 서면싱 어딘구</b> <b>사업자등록번호 000-0000-0000</b></p>
