				...
				<c:when test="${snsfile != null }">
			        ...
			        <input type="hidden" name="writer" value="${snsfile.writer }"/>
						<div class=" sns_grid img1">
							<a class="img-wrapper" href="/admin/readView?bno=${snsfile.bno}&page=${scri.page}&perPageNum=${scri.perPageNum}&searchType=${scri.searchType}&keyword=${scri.keyword}">
