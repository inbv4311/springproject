...
<body>
	...
	<div style="width: 200px; height:auto; margin: 0 auto; padding-bottom:100px;">
		<img src="/img/logo.png" style="margin: 0 auto; width: 100%;">	
	</div>
	...
	<form action="/user/loginPost" method="POST">
		<div id="login">
			...
			<div>
				<input type="submit" class="button" name="로그인" value="로그인"/>
			</div>
		</div>
	</form>
	</div>
