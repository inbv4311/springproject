...
public class RBoardController {
	...
	@RequestMapping("/") 
	public ModelAndView Home(Model model, SearchCriteria scri) throws Exception {
		...
		System.out.println("파일확인 : " + rBoardFileList2 + rBoardFileList3 + rBoardFileList4 + rBoardFileList);
